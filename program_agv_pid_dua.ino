...
if(data1 > 500)s1 = 1; else s1 = 0;
if(data2 > 500)s2 = 1; else s2 = 0;
if(data1 > 500)s3 = 1; else s3 = 0;
if(data2 > 500)s4 = 1; else s4 = 0;
if(data1 > 500)s5 = 1; else s5 = 0;
if(data2 > 500)s6 = 1; else s6 = 0;
if(data2 > 500)s6 = 1; else s7 = 0; 
